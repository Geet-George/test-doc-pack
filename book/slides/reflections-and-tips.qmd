...
- So, what happens when you say `import numpy as np`? Why?
    - All numpy functions, classes, and variables are defined and available for your use.
    - No code is executed because:
        - Either there is no code outside function definitions in numpy
        - Or numpy uses the `if __name__ == "__main__":` construct to prevent code from running on import.
        - The reality is a bit more complex, and is a mix of both.

- Try importing your own scripts and see what happens with defined functions and code outside functions.